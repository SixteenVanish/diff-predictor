...
work_dir = "./work_dirs/tiny/byol/byol_resnet18_1xb256-coslr-200e_tinyimagenet_diff-mlp-sgd-3x0cos-decoderBK"
...
model = dict(
    ...
    loss_byol_mse=0,
    loss_byol_cos=0,
    decoder_layer = "backbone", # default: neck  
...
train_pipeline = [
    ...
    dict(type='MultiView', num_views=2, transforms=[[]]),
