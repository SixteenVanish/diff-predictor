...
work_dir = "./work_dirs/byol_resnet18_1xb256-coslr-200e_tinyimagenet_diff-mlp-sgd-predRes"
...
diff_cfg = dict(
    ...
    diff_prob=1,
    cat_or_add='cat',
    conditioned_on_tgt=False,  # default False
    pred_residual=True,  # default False
)
