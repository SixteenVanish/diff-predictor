...
work_dir = "./work_dirs/byol_resnet18_1xb256-coslr-200e_tinyimagenet_diff-mlp-sgd_v9-2"
...
view_pipeline = [
    ...
    # dict(type='mmpretrain.RandomCrop', crop_size=32),   # 64*0.875=56
    
    # dict(type='mmpretrain.TenCrop', crop_size=32),
    
    dict(type='Resize', scale=64),
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CustomDataset',
        data_root='/home/wangbei/datasets/imagenet/tiny-imagenet-200_format/test',
        data_prefix='test_4class',
