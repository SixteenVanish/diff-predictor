...
work_dir = "./work_dirs/tiny/byol/byol_resnet18_1xb256-coslr-200e_tinyimagenet_multicrops-0.4-OL-0010"
...
num_crops = [2,8]   # default:[1,1]     DINO:[2,8] SwAV:[2,6]
model = dict(
    type='DiffBYOL',
    base_momentum=0.01,
    backbone=dict(
...
view_pipeline2 = [
    dict(
        type='mmpretrain.RandomResizedCrop',
        scale=32,
        crop_ratio_range=(0.05, scale_boundary),
        interpolation='bicubic',
        backend='pillow'),
    dict(type='RandomFlip', prob=0.5, direction='horizontal'),
    dict(
