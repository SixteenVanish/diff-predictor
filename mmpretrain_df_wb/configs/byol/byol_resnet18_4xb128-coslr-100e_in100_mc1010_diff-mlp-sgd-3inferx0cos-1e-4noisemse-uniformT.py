...
work_dir = "./work_dirs/in100/byol/byol_resnet18_4xb128-coslr-100e_in100_mc1010_diff-mlp-sgd-3inferx0cos-1e-4noisemse-uniformT"
resume = True
load_from = "./work_dirs/in100/byol/byol_resnet18_4xb128-coslr-100e_in100_mc1010_diff-mlp-sgd-3inferx0cos-1e-4noisemse-uniformT/epoch_66.pth"
...
default_hooks = dict(
    ...
    checkpoint=dict(max_keep_ckpts=3, interval=3),
    )
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='/ssd/datasets/imagenet/train.txt_100_withlabel.txt',
